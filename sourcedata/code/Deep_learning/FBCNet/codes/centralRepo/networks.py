...
device='cuda'
# summary(deepConvNet(29,29).to(device),(1,29,29),batch_size=16,device='cuda')
# summary(networks.deepConvNet(30,1000,4,0.5).to(device),(1,30,1000),batch_size=16,device='cuda')